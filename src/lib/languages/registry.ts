 ...
 */
export type ParserLanguageId = "typescript" | "tsx" | "javascript" | "python" | "java" | "go" | "rust";
...
export const LANGUAGES: readonly LanguageInfo[] = [
  // Parseable languages
  { id: "typescript", name: "TypeScript", color: "#3b8eea", extensions: ["ts", "tsx", "mts", "cts"], category: "source" },
  { id: "javascript", name: "JavaScript", color: "#f1e05a", extensions: ["js", "jsx", "mjs", "cjs"], category: "source" },
  { id: "python", name: "Python", color: "#4b8bbe", extensions: ["py", "pyi", "pyw"], category: "source" },
  ...
  { id: "cpp", name: "C++", color: "#f34b7d", extensions: ["cpp", "cc", "cxx", "hpp", "hh", "hxx", "ipp", "inl"], category: "source" },
  { id: "csharp", name: "C#", color: "#2ea043", extensions: ["cs"], category: "source" },
  { id: "objective-c", name: "Objective-C", color: "#438eff", extensions: ["m", "mm"], category: "source" },
  ...
  { id: "groovy", name: "Groovy", color: "#4298b8", extensions: ["groovy", "gradle"], category: "build" },
  { id: "ruby", name: "Ruby", color: "#e0535a", extensions: ["rb", "rake", "gemspec"], filenames: ["Gemfile", "Rakefile"], category: "source" },
  ...
  { id: "erlang", name: "Erlang", color: "#d65a6b", extensions: ["erl", "hrl"], category: "source" },
  { id: "haskell", name: "Haskell", color: "#8f7cc4", extensions: ["hs", "lhs"], category: "source" },
  { id: "ocaml", name: "OCaml", color: "#ef7a08", extensions: ["ml", "mli"], category: "source" },
  { id: "fsharp", name: "F#", color: "#b845fc", extensions: ["fs", "fsi", "fsx"], category: "source" },
  { id: "clojure", name: "Clojure", color: "#91dc47", extensions: ["clj", "cljs", "cljc", "edn"], category: "source" },
  ...
  { id: "shell", name: "Shell", color: "#89e051", extensions: ["sh", "bash", "zsh", "fish"], category: "build" },
  { id: "powershell", name: "PowerShell", color: "#4c8fd6", extensions: ["ps1", "psm1", "psd1"], category: "build" },
  { id: "batch", name: "Batchfile", color: "#a3c95f", extensions: ["bat", "cmd"], category: "build" },
  { id: "assembly", name: "Assembly", color: "#9e8f7f", extensions: ["asm", "s"], category: "source" },
  { id: "sql", name: "SQL", color: "#e38c00", extensions: ["sql"], category: "data" },
  { id: "graphql", name: "GraphQL", color: "#e535ab", extensions: ["graphql", "gql"], category: "source" },
  { id: "protobuf", name: "Protocol Buffers", color: "#8fb2d8", extensions: ["proto"], category: "source" },
  { id: "wasm-text", name: "WebAssembly Text", color: "#8f7cff", extensions: ["wat", "wast"], category: "source" },
  // Markup & styles
  { id: "html", name: "HTML", color: "#e34c26", extensions: ["html", "htm", "xhtml"], category: "markup" },
  ...
  { id: "xml", name: "XML", color: "#0aa0d8", extensions: ["xml", "xsd", "xsl", "plist"], category: "markup" },
  { id: "svg", name: "SVG", color: "#ffb13b", extensions: ["svg"], category: "asset" },
  // Docs
  { id: "markdown", name: "Markdown", color: "#6b8cff", extensions: ["md", "mdx", "markdown"], category: "docs" },
  { id: "rst", name: "reStructuredText", color: "#8fa3c8", extensions: ["rst"], category: "docs" },
  { id: "text", name: "Text", color: "#9ca3af", extensions: ["txt"], filenames: ["LICENSE", "AUTHORS", "CODEOWNERS", "NOTICE"], category: "docs" },
  // Data & config
  { id: "json", name: "JSON", color: "#c9c94a", extensions: ["json", "jsonc", "json5"], category: "config" },
  ...
  { id: "ini", name: "INI", color: "#b0b86a", extensions: ["ini", "cfg", "conf", "properties", "env"], category: "config" },
  { id: "csv", name: "CSV", color: "#6fbf73", extensions: ["csv", "tsv"], category: "data" },
  { id: "dockerfile", name: "Dockerfile", color: "#5d8aa8", extensions: ["dockerfile"], filenames: ["Dockerfile", "Containerfile"], category: "build" },
  { id: "makefile", name: "Makefile", color: "#6ea84c", extensions: ["mk", "mak"], filenames: ["Makefile", "GNUmakefile", "makefile"], category: "build" },
  { id: "cmake", name: "CMake", color: "#4fb4d8", extensions: ["cmake"], filenames: ["CMakeLists.txt"], category: "build" },
  { id: "nix", name: "Nix", color: "#7e7eff", extensions: ["nix"], category: "build" },
  { id: "terraform", name: "HCL", color: "#9b7fe6", extensions: ["tf", "tfvars", "hcl"], category: "config" },
];
...
export const BINARY_EXTENSIONS: ReadonlySet<string> = new Set([
  ...
  "zip", "gz", "tgz", "bz2", "xz", "7z", "rar", "tar", "zst", "lz4", "br",
  "jar", "war", "ear", "class", "dex", "apk", "aab", "ipa",
  "so", "dll", "exe", "dylib", "a", "lib", "o", "obj", "pdb", "bin", "dat", "img", "iso", "dmg", "msi", "deb", "rpm",
  "wasm", "node", "pyc", "pyo", "pyd", "whl", "egg", "lockb", "rlib",
  "woff", "woff2", "ttf", "otf", "eot",
  "mp3", "mp4", "m4a", "wav", "ogg", "oga", "flac", "aac", "webm", "mov", "avi", "mkv", "wmv", "flv",
  "sqlite", "sqlite3", "db", "mdb", "parquet", "avro", "orc", "npy", "npz", "pkl", "pickle", "h5", "hdf5", "onnx", "pt", "pth", "ckpt", "safetensors", "tflite",
  "glb", "gltf", "fbx", "blend", "stl", "3ds", "dae", "ktx2", "hdr", "exr",
  "swf", "jks", "keystore", "p12", "pfx", "der", "cer",
]);
...
export function detectLanguage(path: string): LanguageInfo {
  ...
  if (name.toLowerCase().startsWith("dockerfile")) return byId.get("dockerfile") ?? UNKNOWN_LANGUAGE;
  if (extension) {
...
const BUILD_SEGMENTS = new Set(["dist", "build", "out", "target", ".next", ".nuxt", "coverage", "__generated__", "generated", "gen"]);

const TEST_SEGMENTS = new Set(["test", "tests", "__tests__", "spec", "specs", "__mocks__", "testing", "testdata", "fixtures", "__fixtures__", "e2e"]);
...
export function detectCategory(path: string, language: LanguageInfo = detectLanguage(path)): FileCategory {
  const { name } = splitPath(path);
  ...
  if (language.category === "source" || language.category === "style" || language.category === "markup") {
    if (segments.some((segment) => DOCS_SEGMENTS.has(segment)) && language.category !== "source") return "docs";
    return language.category;
  }
  if (language.id === "markdown" || language.id === "rst" || lowerName.startsWith("readme") || lowerName.startsWith("changelog")) {
    return "docs";
  }
  if (lowerName.startsWith(".") || /\.config\.[a-z]+$/.test(lowerName) || /rc(\.[a-z]+)?$/.test(lowerName)) {
    return "config";
  }
  return language.category;
}
